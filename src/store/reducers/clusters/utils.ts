...
import {prepareClusterLinksFields} from '../cluster/parseFields';
...
export const prepareClustersData = (data: MetaClusters): PreparedCluster[] => {
    ...
    return clusters.map((cluster) => {
        const parsedFields = prepareClusterLinksFields(cluster);
        const {settings: parsedSettings} = parsedFields;
