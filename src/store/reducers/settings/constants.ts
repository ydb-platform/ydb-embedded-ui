...
export const SETTING_KEYS = {
    ...
    DATABASES_PAGE_ENVIRONMENT: 'databasesPageEnvironment',
    ...
    ENABLE_NEW_STORAGE_VIEW: 'enableNewStorageView',
    ...
    ENABLE_PDISKS_PREVIEW: 'enablePDisksPreview',
...
export const DEFAULT_USER_SETTINGS = {
    ...
    [SETTING_KEYS.ENABLE_NEW_STORAGE_VIEW]: false,
