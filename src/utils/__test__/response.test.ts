...
describe('isNetworkError', () => {
    ...
    test('should return true for "Failed to fetch" (Chrome)', () => {
        expect(isNetworkError({message: 'Failed to fetch'})).toBe(true);
    });
    test('should return true for "Load failed" (Safari)', () => {
        expect(isNetworkError({message: 'Load failed'})).toBe(true);
    });
    test('should return true for Firefox network error', () => {
        expect(
            isNetworkError({
    ...
    test('should return true case-insensitively for fetch errors', () => {
        expect(isNetworkError({message: 'FAILED TO FETCH'})).toBe(true);
        expect(isNetworkError({message: 'load failed'})).toBe(true);
    });
